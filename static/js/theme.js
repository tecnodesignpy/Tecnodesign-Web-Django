...
function BannerSlider () {
  ...
  var banner_responsive = $("#theme-reponsive-banner");
  if (banner_responsive.length) {
    banner_responsive.camera({ //here I declared some settings, the height and the presence of the thumbnails 
      height: '47%',
      pagination: false,
      navigation: true,
      thumbnails: false,
